package com.yonghui.portal.aop;
...
public class SysLogAspect {
	...
	@Pointcut("@annotation(com.yonghui.portal.annotation.SysLog)")
	...
	public void saveSysLog(JoinPoint joinPoint) {
		...
		com.yonghui.portal.annotation.SysLog syslog = method.getAnnotation(com.yonghui.portal.annotation.SysLog.class);
		if(syslog != null){
			//注解上的描述 
