$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '格式', name: 'imgType', index: 'img_type', width: 80},
            {label: '大小', name: 'imgSize', index: 'img_size', width: 80},
            {
                label: '类型', name: 'tag', index: 'tag', width: 80, formatter: function (tag) {
                if (tag == 1) {
                    return "图片";
                } else if (tag == 2) {
                    return "附件";
            ...
            {label: '根目录', name: 'imgPath', index: 'img_path', width: 80},
        ],
