$(function () {
    $("#jqGrid").jqGrid({
        url: '../businessmancomment/list',     // 请求后台json数据的url
    ...
    methods: {
        query: function () {
            ...
            $("#jqGrid").jqGrid('setGridParam', {
                postData: {
                    id: vm.businessmanComment.id,
                    remark: vm.businessmanComment.remark
                },
                page: 1
            }).trigger("reloadGrid");
        },
        ...
        saveOrUpdate: function (event) {
            var url = vm.businessmanComment.id == null ? "../businessmancomment/save" : "../businessmancomment/update";
            $.ajax({
                type: "POST",
                url: url,
                data: JSON.stringify(vm.businessmanComment),
                success: function(r){
                    if(r.code === 0){
        ...
        getInfo: function(id){
            $.get("../businessmancomment/info/"+id, function(r){
                vm.businessmanComment = r.businessmanComment;
            });
        },
