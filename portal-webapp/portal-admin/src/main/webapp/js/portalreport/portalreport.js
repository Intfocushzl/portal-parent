$(function () {
    $("#jqGrid").jqGrid({
        ...
        colModel: [
            ...
            {label: '执行sql的唯一编码，execute_type为1是对应存储过程编码，为2时对应select查询编码', name: 'executeCode', index: 'execute_code', width: 80 }, 
...
var vm = new Vue({
    ...
    methods: {
        ...
        getInfo: function(id){
            $.get("../portalreport/info/"+id, function(r){
