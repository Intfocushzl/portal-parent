...
$(function () {
    $("#jqGrid").jqGrid({
        url: '/admin/forfront/menu/list',     // 请求后台json数据的url
...
var vm = new Vue({
    ...
    methods: {
        getMenu: function (id) {
            //加载菜单树
            $.get("/admin/forfront/menu/select", function (r) {
        ...
        update: function (event) {
            ...
            $.get("/admin/forfront/menu/info/" + id, function (r) {
                vm.showList = false;
                vm.title = "修改";
                vm.menu = r.menu;
        ...
        del: function (event) {
            ...
            confirm('确定要删除选中的记录？', function () {
                $.ajax({
                    type: "POST",
                    url: "/admin/forfront/menu/delete",
        ...
        saveOrUpdate: function (event) {
            var url = vm.menu.id == null ? "/admin/forfront/menu/save" : "/admin/forfront/menu/update";
