...
public class DataMapIndexAperture implements Serializable {
	...
	private String sprocess;// 二级流程
	private String theme;// 主题
	private String fieldname;// 字段名
	private String indexname;// 指标名称
	private String fristdef;// 一集群定义
	private String bravodef;// 二集群定义
	private String otherdef;// 其他平台定义
	private String measure;// 衡量内容
	private String ds;// 数据源
	private String tablename;// 表名
	private String cman;// 负责人姓名
	private String cmanphone;// 负责人电话
	private String cmanemail;// 负责人邮箱
	private String platform;// 平台
	private String connectioninfo;// 连接名
	private String database;// 数据库
	private String sql;// sql语法
	private String created_by;// 创建人
	private String cindexname;// 关联指标
	private String ctablename;// 关联表
	private String bloodrelation;// 血缘分析
